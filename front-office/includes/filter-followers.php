...
include('./db-connect.php');
        ...
        $selectArticles = $bdd->prepare('SELECT id_article, picture, `date`, user_id_author, username_author, title, teaser FROM articles, abonnement WHERE user_id_subscription = user_id_author AND user_id_follow = ?');
        $selectArticles->execute([$_SESSION['user_id']]);
        ...
        echo "<p>Encore aucun article n'a été posté par un de vos abonnements...</p></div>";
    }
?>